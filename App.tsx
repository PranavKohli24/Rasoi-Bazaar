      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
            <div className="animate-fade-in-up">
                <h1 className="font-serif text-6xl sm:text-8xl font-black text-white drop-shadow-2xl">
                   RasoiBazaar
                </h1>
                <p className="mt-4 text-xl text-orange-200/90 max-w-2xl mx-auto">
                    Your personal guide to authentic, home-style Indian cooking. What delicious journey will you embark on?
                </p>
            </div>
